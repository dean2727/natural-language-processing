...
# given a list of words, their corresponding vector representations, and a target word, return the words that have smallest cosine distance between vector reps and target word
