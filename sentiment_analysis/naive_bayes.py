...
# Add your review:
review = "So far, I have gotten started with NLP, learning the fundamentals of text preprocessing and parsing, language models, text similarity, and language prediction! I am very interested in this so far, and I cant wait to see where God takes me with it!"
